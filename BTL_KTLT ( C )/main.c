...
void Tao_data_lop_6A1(){
    ...
    Hoc_sinh[2]=(Student){
        ...
        .subject = {
            ...
            { .subject_name = PE, .score = { {4.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
        }
    };
    ...
    Hoc_sinh[3]=(Student){
        ...
        .subject = {
            ...
            { .subject_name = Physics, .score = { {8.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Chemistry, .score = { {5.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Biology, .score = { {5.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Informatics, .score = { {8.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Literatures, .score = { {9.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = History, .score = { {7.5, 5.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Geography, .score = { {1.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Language, .score = { {9.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Moral_Education, .score = { {8.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
            { .subject_name = Technical, .score = { {4.5, 7.0, 8.5, 7.7}, {7.3, 8.0}, 7.9, 8.7 } },
